    ...
    public void getFileContent(HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            Node grupos = grupoList.item(T1.getGrupocotizacion()-1);
                    ...
                    Element grupo = (Element) grupos;
              
                        grupo.getElementsByTagName("salarios");
                        for (int j = 0; j < nameList.getLength(); j++) {
                            ...
                            if (node.getNodeType() == Node.ELEMENT_NODE) {
                                ...
                                String prueba = grupo.getAttribute("grupo");

                                System.out.println(grupo.getAttribute("grupo"));
                            }
